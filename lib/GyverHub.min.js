...
if(this.cfg.use_mqtt)this.mqtt.discover();if(this.cfg.use_serial)this.serial.discover();if(this.cfg.use_bt)this.bt.discover();if(this.cfg.use_local&&!isSSL())this.http.discover();this._checkDiscoverEnd();}
search(){if(this.cfg.use_mqtt)this.mqtt.search();if(this.cfg.use_serial)this.serial.search();if(this.cfg.use_bt)this.bt.search();if(this.cfg.use_local&&!isSSL())this.http.search();this._checkDiscoverEnd();}
